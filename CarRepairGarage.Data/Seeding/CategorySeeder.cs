namespace CarRepairGarage.Data.Seeding
{
    ...
    /// <summary>
    /// Class responsible for seeding the application database with initial Category data.
    /// </summary>
    public class CategorySeeder : ISeeder
    {
        /// <summary>
        /// Seeds the application database with initial Category data if the table is empty.
        /// </summary>
