namespace CarRepairGarage.Data.Seeding
{
    ...
    /// <summary>
    /// Class responsible for seeding the application database with initial Garage data.
    /// </summary>
    public class GarageSeeder : ISeeder
    {
        /// <summary>
        /// Seeds the application database with initial Garage data if the table is empty.
        /// </summary>
        ...
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            Guid userGuid = userManager.FindByNameAsync(CarRepairGarage.Common.GeneralApplicationConstants.AccountsData.ManagerEmail).Result.Id;
